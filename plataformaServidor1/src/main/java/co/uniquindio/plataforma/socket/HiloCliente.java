...
public class HiloCliente implements Runnable {
    ...
    private final ProcesadorXML procesador = new ProcesadorXML();

    private final File directorioPublicadores = new File("C:\\Users\\57310\\OneDrive\\Escritorio\\ArticulosSocios");
